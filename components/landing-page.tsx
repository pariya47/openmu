      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 bg-gradient-to-b from-slate-50/50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <div className="inline-flex items-center justify-center p-2 bg-slate-100 rounded-full mb-4 sm:mb-6">
              <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            {researchChallenges.map((challenge, index) => (
              <Card 
                key={index} 
                className={`group relative overflow-hidden border-2 ${challenge.borderColor} bg-gradient-to-br ${challenge.gradient} hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 sm:hover:-translate-y-3 hover:scale-[1.01] sm:hover:scale-[1.02]`}
              >
          ...
          <div className="text-center mt-12 sm:mt-16 md:mt-20 px-4">
            <div className="inline-flex items-center space-x-2 text-slate-600 mb-4 sm:mb-6">
              <div className="w-8 sm:w-12 h-px bg-gradient-to-r from-transparent to-slate-300" />
              <span className="text-sm font-medium whitespace-nowrap">Ready to overcome these challenges?</span>
