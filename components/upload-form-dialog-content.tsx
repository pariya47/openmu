...
interface UploadFormDialogContentProps {
  onUploadSuccess: (file: UploadedFile, email: string) => void;
  onUploadError: (error: string) => void;
}

export function UploadFormDialogContent({ onUploadSuccess, onUploadError }: UploadFormDialogContentProps) {
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    try {
      ...
      onUploadSuccess(uploadedFile, email);
  ...
  }, [canProceed, isEmailValid, isTurnstileSolved, turnstileToken, email, onUploadSuccess, onUploadError]);
