...
export function LandingPage() {
  ...
  const impactData = [
    { category: 'Time Saved', value: 75, unit: '%', icon: <Clock className="h-5 w-5" /> },
    { category: 'Comprehension', value: 85, unit: '%', icon: <Brain className="h-5 w-5" /> },
    { category: 'Research Speed', value: 60, unit: '%', icon: <TrendingUp className="h-5 w-5" /> },
    { category: 'Knowledge Retention', value: 70, unit: '%', icon: <Award className="h-5 w-5" /> }
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text">
                OpenMU
              </span>
            </div>
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className={`container mx-auto text-center max-w-5xl relative transition-all duration-1000 ${
          ...
          <Badge variant="secondary" className="mb-8 text-sm px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button size="lg" className="text-lg px-10 py-7 shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-105">
              Join Waitlist
              <ArrowRight className="ml-3 h-5 w-5" />
            </Button>
            <Button variant="outline" size="lg" className="text-lg px-10 py-7 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
          ...
          {/* Coming Soon Badge */}
          <div className="inline-flex items-center gap-3 bg-secondary/50 backdrop-blur-sm px-8 py-4 rounded-full border shadow-lg">
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">The Research Challenge</h2>
            ...
            {painPoints.map((point, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border-0 shadow-lg">
                <CardHeader className="pb-4">
                  <div className="mx-auto mb-6 p-4 rounded-2xl bg-muted group-hover:bg-primary/10 transition-colors duration-300">
                    {point.icon}
                  </div>
            ...
            <Card className="lg:sticky lg:top-32 shadow-xl border-0">
              <CardHeader className="pb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-2xl">{features[selectedFeature].title}</CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center text-sm text-muted-foreground bg-muted/50 p-4 rounded-lg">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-base">Undergraduate & Graduate</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-base">Academic & Industry</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-base">Industry Leaders</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold mb-8">Our Community Distribution</h3>
              ...
              <div className="flex justify-center flex-wrap gap-6">
                {audienceData.map((item, index) => (
                  <div key={index} className="flex items-center space-x-3 bg-background/50 px-4 py-2 rounded-full border">
                    <div 
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-8">
                {impactData.map((item, index) => (
                  <div key={index} className="space-y-4 p-6 rounded-xl bg-muted/50 hover:bg-muted/70 transition-colors">
            ...
            <div>
              ...
              <Tabs value={testimonialFilter} onValueChange={setTestimonialFilter} className="mb-8">
                <TabsList className="grid w-full grid-cols-4 h-12">
                  <TabsTrigger value="all" className="text-sm">All</TabsTrigger>
                  <TabsTrigger value="students" className="text-sm">Students</TabsTrigger>
                  <TabsTrigger value="researchers" className="text-sm">Researchers</TabsTrigger>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-background to-muted/50 overflow-hidden">
            <CardContent className="p-12">
              ...
              <h3 className="text-3xl font-bold mb-4">Our Discord Community</h3>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-10">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Connect with like-minded researchers</p>
                </div>
                <div className="text-center">
                  <div className="p-4 rounded-xl bg-primary/10 w-fit mx-auto mb-3">
                    <Lightbulb className="h-6 w-6 text-primary" />
                  </div>
                  <h4 className="font-semibold mb-2">Share Insights</h4>
                  <p className="text-sm text-muted-foreground">Discuss research and discoveries</p>
                </div>
                <div className="text-center">
                  <div className="p-4 rounded-xl bg-primary/10 w-fit mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">Get first access to new features</p>
                </div>
              </div>
              
              <Button 
                size="lg" 
                className="text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-105"
      ...
      <section id="legal" className="py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Trust & Transparency</h2>
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-6">
            <AccordionItem value="privacy" className="border rounded-xl px-8 py-2 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <AccordionContent className="text-muted-foreground pt-6 pb-8 px-4">
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                        <span>Private research activity</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
            ...
            <AccordionItem value="terms" className="border rounded-xl px-8 py-2 shadow-lg hover:shadow-xl transition-shadow">
              <AccordionTrigger className="text-left hover:no-underline py-6">
                <div className="flex items-center space-x-4">
                  <div className="p-3 rounded-xl bg-primary/10">
                    <BookOpen className="h-6 w-6 text-primary" />
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Fair use guidelines and platform rules</p>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground pt-6 pb-8 px-4">
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                        <span>Academic and professional use encouraged</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                        <span>No commercial redistribution</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                        <span>Service availability transparency</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <AccordionItem value="refund" className="border rounded-xl px-8 py-2 shadow-lg hover:shadow-xl transition-shadow">
              <AccordionTrigger className="text-left hover:no-underline py-6">
                <div className="flex items-center space-x-4">
                  <div className="p-3 rounded-xl bg-primary/10">
                  ...
                  <div>
                    <span className="text-xl font-semibold">Cancellation & Refund Policy</span>
                    <p className="text-sm text-muted-foreground mt-1">Flexible cancellation and refund options</p>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground pt-6 pb-8 px-4">
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                        <span>Pro-rated annual refunds</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-center space-x-3 hover:text-foreground transition-colors cursor-pointer">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8 text-sm text-muted-foreground mt-6 md:mt-0">
